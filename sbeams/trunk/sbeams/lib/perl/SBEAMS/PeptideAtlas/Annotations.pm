...
sub get_column_defs {
  ...
  my %coldefs = ( 
      ...
      'TIC' => 'Total ion current in Millions',
			...
			'nP0-.01' => 'PTMProphet probability < 0.01',
			'nP.01-.05' => 'PTMProphet probability >= 0.01 and < 0.05',
			'nP.05-.20' => 'PTMProphet probability >= 0.05 and < 0.2',
			'nP.20-.80'=> 'PTMProphet probability >= 0.2 and < 0.80',
			'nP.80-.95' => 'PTMProphet probability >= 0.80 and < 0.95',
			'nP.95-.99' => 'PTMProphet probability >= 0.95 and < 0.99',
